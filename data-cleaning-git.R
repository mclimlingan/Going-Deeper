...
#I did enrollment_by_race_ethnicity_18_19 case_when on line 48 a little different from the solution video
#but tried to use the str_remove function for the 17-18 and it doesn't seem to work                                                      
